...
extension UIView {
    ...
    ///   - closure: 约束
    /// - Returns:  UIImageView
    class func zj_createImageView(imageName : String? , contentMode : UIView.ContentMode? = nil,supView : UIView? ,closure:(_ make : ConstraintMaker) ->()) -> UIImageView {
    ...
    ///   - closure: 约束
    /// - Returns:  UIButton
    class func zj_createButton(title : String?,titleStatu : UIControl.State?,titleColor: UIColor? = nil,imageName : String?,imageStatu : UIControl.State?, font : UIFont? = FontSize(14),supView : UIView? ,closure:(_ make : ConstraintMaker) ->()) -> UIButton{
        let btn = UIButton()
    ...
    ///   - closure:  make
    /// - Returns: UITextField
    class func zj_createTextField(text : String? , textColor : UIColor?, placeholder: String, font : UIFont?, textAlignment : NSTextAlignment = .left, borderStyle :UITextField.BorderStyle = .none,supView : UIView? ,closure:(_ make : ConstraintMaker) ->()) -> UITextField {
